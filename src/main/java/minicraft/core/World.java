...
public class World extends Game {
	...
	public static final int[] idxToDepth = {-3, -2, -1, 0, 1, 2, -4}; /// This is to map the level depths to each level's index in Game's levels array. This must ALWAYS be the same length as the levels array, of course.
