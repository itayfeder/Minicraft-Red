...
public class FurnitureItem extends Item {
	...
	protected static ArrayList<Item> getAllInstances() {
		...
		items.add(new FurnitureItem(new Spawner(new Piglin(1)), 11, 28));
		items.add(new FurnitureItem(new Spawner(new Blaze(1)), 12, 28));
		...
		items.add(new FurnitureItem(new ObsidianPortal(false), 5, 21));
