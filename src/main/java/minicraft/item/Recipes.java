...
public class Recipes {
	...
	static {
		...
		workbenchRecipes.add(new Recipe("Basalt Brick_1", "Basalt_2"));
		workbenchRecipes.add(new Recipe("Basalt Wall_1", "Basalt Brick_3"));
		workbenchRecipes.add(new Recipe("Basalt Door_1", "Basalt Brick_5"));
		workbenchRecipes.add(new Recipe("Obsidian Portal_1", "Raw Obsidian_12"));
		...
		anvilRecipes.add(new Recipe("Flint And Steel_1", "Iron_1", "coal_1"));
