...
public class TileItem extends StackableItem {
	...
	protected static ArrayList<Item> getAllInstances() {
		...
		items.add(new TileItem("Netherrock", (new Sprite(0, 21, 0)), "netherrock", "hole", "water", "lava"));
		items.add(new TileItem("Basalt Brick", (new Sprite(2, 21, 0)), "Basalt Bricks", "hole", "water", "cloud", "lava"));
		items.add(new TileItem("Basalt Wall", (new Sprite(3, 21, 0)), "Basalt Wall", "Basalt Bricks"));
		items.add(new TileItem("Basalt Door", (new Sprite(4, 21, 0)), "Basalt Door", "Basalt Bricks"));
		items.add(new TileItem("Soul Sand", (new Sprite(5, 21, 0)), "soul sand", "hole", "water", "lava"));
