...
import minicraft.level.tile.nether.BasaltTile;
import minicraft.level.tile.nether.NetherrockTile;
import minicraft.level.tile.nether.SoulSandTile;
...
public final class Tiles {
	...
	public static void initTileList() {
		...
		tiles.set(47, new NetherrockTile("Netherrock"));
		tiles.set(48, new DoorTile(Tile.Material.Basalt));
		tiles.set(49, new FloorTile(Tile.Material.Basalt));
		tiles.set(50, new BasaltTile("Basalt"));
		tiles.set(51, new WallTile(Tile.Material.Basalt));
		tiles.set(52, new SoulSandTile("Soul Sand"));
