...
public class Structure {
	...
	static final Structure netherDungeonCenter;
	static final Structure netherDungeonNorth;
	static final Structure netherDungeonSouth;
	static final Structure netherDungeonEast;
	static final Structure netherDungeonWest;
	...
	static {
		...
		netherDungeonCenter = new Structure();
		netherDungeonCenter.setData("B:Basalt Bricks,W:Basalt Wall",
				"WWBWW\n" +
						"WBBBW\n" +
						"BBBBB\n" +
						"WBBBW\n" +
		...
		netherDungeonNorth = new Structure();
		netherDungeonNorth.setData("B:Basalt Bricks,W:Basalt Wall",
				"WWWWW\n" +
						"WBBBB\n" +
						"BBBBB\n" +
						"WBBBB\n" +
		...
		netherDungeonSouth = new Structure();
		netherDungeonSouth.setData("B:Basalt Bricks,W:Basalt Wall",
				"WWWWW\n" +
						"BBBBW\n" +
						"BBBBB\n" +
						"BBBBW\n" +
		...
		netherDungeonEast = new Structure();
		netherDungeonEast.setData("B:Basalt Bricks,W:Basalt Wall",
				"WBBBW\n" +
						"WBBBW\n" +
						"WBBBW\n" +
						"WBBBW\n" +
		...
		netherDungeonWest = new Structure();
		netherDungeonWest.setData("B:Basalt Bricks,W:Basalt Wall",
				"WWBWW\n" +
						"WBBBW\n" +
						"WBBBW\n" +
						"WBBBW\n" +
