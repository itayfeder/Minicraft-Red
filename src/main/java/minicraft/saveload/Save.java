...
public class Save {
	...
	public static String writeEntity(Entity e, boolean isLocalSave) {
		...
		if (isLocalSave && (e instanceof ItemEntity || e instanceof Arrow || e instanceof Fireball || e instanceof Spark || e instanceof Particle)) // Write these only when sending a world, not writing it. (RemotePlayers are saved separately, when their info is received.)
			return "";
		...
		if(e instanceof ObsidianPortal) extradata.append(":").append(((ObsidianPortal) e).lit);
